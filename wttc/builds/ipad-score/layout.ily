...
Breaks = {
    ...
    % [Breaks measure 12]
    \baca-lbsd #0 #'(15 20 25 17.5 17.5 20)
    \pageBreak
    s1 * 3/4
    ...
    % [Breaks measure 21]
    \baca-lbsd #0 #'(15 20 22.5 17.5 20 20)
    \pageBreak
    s1 * 4/4
    ...
    % [Breaks measure 100]
    \baca-lbsd-xy #55 #0 #'(15 20 20 20 20 20)
    \pageBreak
    s1 * 2/4
    ...
    % [Breaks measure 105]
    \baca-lbsd #0 #'(15 15 30 17.5 17.5 20)
    \pageBreak
    s1 * 9/4
    ...
    % [Breaks measure 340]
    \baca-lbsd-xy #20 #0 #'(15 20 20 20 20 20)
    \pageBreak
    s1 * 3/4
    ...
    % [Breaks measure 360]
    \baca-lbsd-xy #40 #0 #'(15 15 30 17.5 17.5 20)
    \pageBreak
    s1 * 4/4
    ...
    % [Breaks measure 482]
    \baca-lbsd-xy #30 #0 #'(15 20 20 20 20 20)
    \pageBreak
    s1 * 1/4
    ...
    % [Breaks measure 498]
    \baca-lbsd-xy #48 #0 #'(15 20 20 20 20 20)
    \pageBreak
    s1 * 5/4
...
SpacingCommands = {
    ...
    \baca-start-nonstrict-spacing-section #1 #22
    s1 * 3/4

    % [SpacingCommands measure 11]
    \baca-start-nonstrict-spacing-section #35 #528
    s1 * 6/4
    ...
    \baca-start-nonstrict-spacing-section #35 #480
    s1 * 6/4
    ...
    \baca-start-nonstrict-spacing-section #1 #24
    s1 * 6/4

    % [SpacingCommands measure 122]
    \baca-start-nonstrict-spacing-section #35 #576
    s1 * 5/4
    ...
    \baca-start-nonstrict-spacing-section #1 #28
    s1 * 6/4

    % [SpacingCommands measure 256]
    \baca-start-nonstrict-spacing-section #35 #672
    s1 * 4/4
    ...
    \baca-start-nonstrict-spacing-section #35 #384
    s1 * 6/4
    ...
    \baca-start-nonstrict-spacing-section #1 #13
    \once \override Score.CenteredBarNumber.transparent = ##t
    s1 * 3/4
    ...
    \baca-start-nonstrict-spacing-section #35 #312
    s1 * 6/4
    ...
    \baca-start-strict-spacing-section #1 #17
    \once \override Score.CenteredBarNumber.transparent = ##t
    s1 * 4/4
    ...
    \baca-start-strict-spacing-section #35 #408
    s1 * 4/4
    ...
    \baca-start-strict-spacing-section #1 #11
    s1 * 6/4
    ...
    \baca-start-strict-spacing-section #35 #264
    s1 * 3/4
    ...
    \baca-start-strict-spacing-section #1 #112
    s1 * 1/4
    ...
    \baca-start-strict-spacing-section #1 #128
    s1 * 1/4
    ...
    \baca-start-strict-spacing-section #35 #3072
    s1 * 1/4
