...
\markup scene-i-title-parts-positioning = \markup \translate #'(50 . 18) \etc
\markup scene-i-A-parts-positioning = \markup
  \override #'(line-width . 160)
  \translate #'(68 . 20)
  \etc
\markup scene-i-B-parts-positioning = \markup
  ...
  \translate #'(-82 . -25)
  \etc
\markup scene-i-C-parts-positioning = \markup \translate #'(-10 . -30) \etc
\markup scene-i-D-parts-positioning = \markup \translate #'(-24 . -32) \etc
...
\markup scene-iii-title-parts-positioning = \markup \translate #'(-10 . 8) \etc
\markup scene-iii-A-parts-positioning = \markup \translate #'(-33 . -22) \etc
...
\markup scene-iii-E-parts-positioning = \markup \translate #'(-40 . -21) \etc
...
\markup scene-iv-C-parts-positioning = \markup \translate #'(-10 . -18) \etc
\markup scene-iv-D-parts-positioning = \markup \translate #'(0 . -18) \etc
\markup scene-iv-E-parts-positioning = \markup \translate #'(0 . -18) \etc
\markup scene-iv-F-parts-positioning = \markup \translate #'(-20 . -18) \etc
...
\markup scene-iv-J-parts-positioning = \markup
  ...
  \translate #'(72 . -18)
  \etc
\markup scene-iv-K-parts-positioning = \markup \translate #'(32 . -15) \etc
...
\markup scene-vi-title-parts-positioning = \markup \translate #'(-8 . 14) \etc
\markup scene-vi-A-parts-positioning = \markup \translate #'(30 . 14) \etc
\markup scene-vi-B-parts-positioning = \markup \translate #'(-10 . -17) \etc
\markup scene-vi-C-parts-positioning = \markup \translate #'(0 . -17) \etc
...
\markup scene-vi-F-parts-positioning = \markup
  ...
  \translate #'(-52 . -18)
  \etc
\markup scene-vi-G-parts-positioning = \markup \translate #'(-70 . -18.5) \etc
