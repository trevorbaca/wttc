...
def owl(skips):
    ...
    baca.markup(
        skips[33 - 1],
        r"\scene-xii-D-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[36 - 1],
        r"\scene-xii-E-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[39 - 1],
        r"\scene-xii-F-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[42 - 1],
        r"\scene-xii-G-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[45 - 1],
        r"\scene-xii-H-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[47 - 1],
