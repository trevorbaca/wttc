...
number.9.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-vi-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-vi-title-section-format
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-vi-E-section-format
      %! +SECTION
    _ \scene-vi-D-section-format
      %! CLOCK_TIME
    \bacaStopTextSpanCT
      %! LOCAL_MEASURE_NUMBER
    \bacaStopTextSpanLMN
    ...
    \bacaStartTextSpanMN
      %! STAGE_NUMBER
    %@% - \baca-start-snm-left-only "[M18] C + G"
      %! STAGE_NUMBER
    %@% \bacaStartTextSpanSNM
...
number.9.AltoFlute.Staff = <<

    \context Voice = "AltoFlute.Music"
    { \number.9.AltoFlute.Music }
...
number.9.Guitar.1.Staff = <<

    \context Voice = "Guitar.1.Music"
    { \number.9.Guitar.1.Music }

>>


number.9.Guitar.2.Music = {
...
number.9.Guitar.2.Staff = <<

    \context Voice = "Guitar.2.Music"
    { \number.9.Guitar.2.Music }
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    :32
    {
        ...
        \once \override NoteColumn.X-extent = #'(0 . 3)
        \revert Accidental.stencil
        \revert NoteColumn.glissando-skip
        \revert NoteHead.no-ledgers
        \undo \hide NoteHead
