...
def GLOBALS(skips):
    ...
    wrappers = baca.override.metronome_mark_extra_offset(skips[5 - 1], (0, 3))
    ...
    wrappers = baca.override.metronome_mark_extra_offset(skips[8 - 1], (-3, 2))
...
def vn(m):
    ...
    library.E2c(runs[3], "B3", "C#4", "p", ftblt=True)
