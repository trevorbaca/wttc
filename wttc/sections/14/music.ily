...
number.14.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-ix-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-ix-title-section-format
      %! +SECTION
    _ \scene-ix-B-section-format
    ...
    \bacaStartTextSpanMN
      %! STAGE_NUMBER
    %@% - \baca-start-snm-left-only "[M26 = M24] D + H + M"
      %! STAGE_NUMBER
    %@% \bacaStartTextSpanSNM
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-ix-C-continued-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-ix-C-section-format
      %! CLOCK_TIME
    \bacaStopTextSpanCT
      %! LOCAL_MEASURE_NUMBER
    \bacaStopTextSpanLMN
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-ix-parenthesized-title-section-format
      %! +SECTION
    _ \scene-ix-D-section-format
      %! CLOCK_TIME
    \bacaStopTextSpanCT
      %! LOCAL_MEASURE_NUMBER
    \bacaStopTextSpanLMN
    ...
    \bacaStopTextSpanMN
      %! CLOCK_TIME
    - \baca-start-ct-both "[14'16'']" "[14'22'']"
      %! CLOCK_TIME
    \bacaStartTextSpanCT
      %! LOCAL_MEASURE_NUMBER
...
number.14.AltoFlute.Staff = <<

    \context Voice = "AltoFlute.Music"
    { \number.14.AltoFlute.Music }
...
number.14.Guitar.1.Staff = <<

    \context Voice = "Guitar.1.Music"
    { \number.14.Guitar.1.Music }
...
number.14.Guitar.2.Staff = <<

    \context Voice = "Guitar.2.Music"
    { \number.14.Guitar.2.Music }
