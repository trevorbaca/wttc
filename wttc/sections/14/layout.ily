...
% measure_count = 16 + 1
% time_signatures = [
% '6/4', '6/4', '6/4', '6/4', '6/4', '6/4', '6/4', '4/4', '4/4', '6/4', '6/4',
%  '6/4', '6/4', '6/4', '6/4', '6/4'
%  ]
...
<<
    ...
    \context GlobalContext = "GlobalContext"
    {
        ...
        {   %*% PageLayout
            ...
            \autoPageBreaksOff
              %! BREAK
            \baca-lbsd-xy #60 #10 #'(10 20 30 20 20 20)
              %! SPACING_COMMAND
            ...
            % [PageLayout measure 9]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #35 #1536
              %! BREAK
            \noBreak
            s1 * 4/4
              %! SPACING
            %@% \bacaStopTextSpanSPM
              %! SPACING
            %@% - \baca-start-spm-left-only "[[1/64 * 35/24]]"
              %! SPACING
            %@% \bacaStartTextSpanSPM
