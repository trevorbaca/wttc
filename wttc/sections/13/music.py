...
def owl(skips):
    baca.markup(
        skips[1 - 1],
        r"\scene-viii-A-section-position",
        baca.tweak.x_extent_false(),
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[1 - 1],
        r"\scene-viii-B-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[9 - 1],
        r"\scene-viii-C-section-position",
        baca.tweak.x_extent_false(),
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[10 - 1],
        r"\scene-viii-D-section-position",
        direction=abjad.DOWN,
    )
    baca.markup(
        skips[11 - 1],
        r"\scene-viii-E-section-position",
        baca.tweak.x_extent_false(),
        direction=abjad.DOWN,
    )
...
def persist_score(score, environment):
    ...
    lilypond_file = baca.lilypond.file(
        ...
        includes=["../stylesheet.ily", "../../staging/scene-viii.ily"],
    )
...
def make_layout():
    breaks = baca.layout.Breaks(
        baca.layout.Page(
            ...
            baca.layout.System(10, y_offset=160, distances=(8, 20, 20, 20, 20, 20)),
        ),
    )
