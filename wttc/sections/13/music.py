...
def owl(skips):
    wrappers = baca.markup(
        skips[1 - 1],
        r"\scene-viii-title-section-format",
    ...
    wrappers = baca.markup(
        skips[1 - 1],
        r"\scene-viii-B-section-format",
        direction=abjad.DOWN,
    )
    baca.tags.tag(wrappers, baca.tags.ONLY_SECTION)
    wrappers = baca.markup(
        skips[9 - 1],
        r"\scene-viii-C-section-format",
        baca.tweak.x_extent_false(),
        direction=abjad.DOWN,
    )
    baca.tags.tag(wrappers, baca.tags.ONLY_SECTION)
    wrappers = baca.markup(
        skips[10 - 1],
        r"\scene-viii-D-section-format",
        direction=abjad.DOWN,
    )
    baca.tags.tag(wrappers, baca.tags.ONLY_SECTION)
    wrappers = baca.markup(
        skips[11 - 1],
        r"\scene-viii-E-section-format",
        baca.tweak.x_extent_false(),
        direction=abjad.DOWN,
    )
    baca.tags.tag(wrappers, baca.tags.ONLY_SECTION)
