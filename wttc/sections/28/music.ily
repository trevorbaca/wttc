...
number.28.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xviii-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xviii-title-section-format
      %! +SECTION
    _ \scene-xviii-B-section-format
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xviii-C-section-format
      %! CLOCK_TIME
    \bacaStopTextSpanCT
      %! LOCAL_MEASURE_NUMBER
    \bacaStopTextSpanLMN
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xviii-D-section-format
      %! CLOCK_TIME
    \bacaStopTextSpanCT
      %! LOCAL_MEASURE_NUMBER
    \bacaStopTextSpanLMN
