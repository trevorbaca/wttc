...
number.30.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xx-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xx-B-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-xx-title-section-format
    ...
    \bacaStopTextSpanMN
      %! CLOCK_TIME
    - \baca-start-ct-both "[29'11'']" "[29'17'']"
      %! CLOCK_TIME
    \bacaStartTextSpanCT
      %! LOCAL_MEASURE_NUMBER
...
number.30.AltoFlute.Staff = <<

    \context Voice = "AltoFlute.Music"
    { \number.30.AltoFlute.Music }

>>


number.30.Oboe.Music = {
...
number.30.Guitar.1.Staff = <<

    \context Voice = "Guitar.1.Music"
    { \number.30.Guitar.1.Music }
...
number.30.Guitar.2.Staff = <<

    \context Voice = "Guitar.2.Music"
    { \number.30.Guitar.2.Music }
...
number.30.Violin.Staff = <<

    \context Voice = "Violin.Music"
    { \number.30.Violin.Music }

>>


number.30.Cello.Music = {
...
number.30.Cello.Staff = <<

    \context Voice = "Cello.Music"
    { \number.30.Cello.Music }
