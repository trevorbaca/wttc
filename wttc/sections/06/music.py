...
def GLOBALS(skips):
    ...
    wrappers = baca.override.metronome_mark_extra_offset(skips[2 - 1], (0, 2))
    baca.tags.tag(wrappers, library.ONLY_LETTER_PARTS_GUITAR_2)
...
def vn(m):
    ...
    wrappers = baca.override.metronome_mark_extra_offset(m[1][0], (0, 3))
