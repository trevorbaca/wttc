...
number.6.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-iv-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-iv-title-section-format
      %! +SECTION
    _ \scene-iv-B-section-format
