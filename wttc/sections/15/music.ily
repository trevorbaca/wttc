...
number.15.Skips = {
    ...
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-x-A-section-format
      %! +SECTION
    - \tweak X-extent ##f
      %! +SECTION
    _ \scene-x-title-section-format
      %! +SECTION
    _ \scene-x-B-section-format
    ...
    \bacaStartTextSpanMN
      %! STAGE_NUMBER
    %@% - \baca-start-snm-left-only "[M28] z: L"
      %! STAGE_NUMBER
    ...
    \bacaStartTextSpanMN
      %! STAGE_NUMBER
    %@% - \baca-start-snm-left-only "[M29] xz: J (beginning)"
      %! STAGE_NUMBER
    %@% \bacaStartTextSpanSNM
    ...
    \bacaStartTextSpanMN
      %! STAGE_NUMBER
    %@% - \baca-start-snm-left-only "[M30 = M14] x: ABC + yz: A (end)"
      %! STAGE_NUMBER
    %@% \bacaStartTextSpanSNM
    ...
    \bacaStopTextSpanMN
      %! CLOCK_TIME
    - \baca-start-ct-both "[14'45'']" "[14'50'']"
      %! CLOCK_TIME
    \bacaStartTextSpanCT
      %! LOCAL_MEASURE_NUMBER
