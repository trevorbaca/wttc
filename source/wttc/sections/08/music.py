...
def GLOBALS(skips):
    ...
    wrappers = baca.override.metronome_mark_extra_offset(skips[9 - 1], (0, 3))
    ...
    wrappers = baca.override.metronome_mark_extra_offset(skips[10 - 1], (5, 3))
    baca.tags.tag(wrappers, library.ONLY_LETTER_PARTS_GUITAR_2)
...
def ob(m):
    ...
    library.C2a(library.pleaves(m[5], 2), "E6", "F6", "mf", "Eb6", hftblt=True)
    library.D1a(library.pleaves(m[7, 8], 1), "D6", "mf", rleak=True, hftblt=True)
...
def vn(m):
    ...
    library.A1b(library.pleaves(m[4, 5], 1), "E4 G#4", "pp p mp mp", hftblt=True)
